  ...
  return (  
    <div className={styles.Home} id='home'>
      <section className= 'text-white mt-10 mx-[7%] flex justify-between items-center max-lg:flex-wrap' >
        ...
        >
          <h1 className={`${styles.customClass} font-bold text-[80px] leading-[53px] customClass`} >Build Your <br /> Awesome <br /> Platform</h1>
      ...
      <section className='mt-20'>
        <div className='text-white mx-[7%]'>
          <div className='flex justify-between flex-wrap gap-10'><h1 className={`${styles.customClass} font-bold text-[60px] leading-[54px]`}>Why Enver Is The <br /> Best Choice?</h1><h1 className='text-[#D9D9D9] text-[13px] max-md:text-[16px]'>Watch this one minute video so you understand why you should <br /> use our services!</h1></div>
          <div>
